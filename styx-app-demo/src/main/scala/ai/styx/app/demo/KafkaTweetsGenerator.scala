...
object KafkaTweetsGenerator extends App with Logging {

  lazy val config: Configuration = Configuration.load()
  val topic: String = "tweets" // Configuration.load().kafkaConfig.rawDataTopic
  ...
  // load data file
  val dataSourcePath = "sampleTweets.json"
