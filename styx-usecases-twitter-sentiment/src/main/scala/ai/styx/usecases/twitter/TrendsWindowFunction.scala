...
class TrendsWindowFunction(evaluationPeriodInSeconds: Int, dateTimePattern: String, topN: Int) extends AllWindowFunction[WordCount, Map[String, List[Trend]], TimeWindow] {
